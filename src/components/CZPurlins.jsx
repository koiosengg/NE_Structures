  ...
  return (
    <div className="product PEB">
      ...
      <div className="homeInfoContainer">
        <div className="heading">
          <p>
            Unmatched Features for <br /> <span> Ultimate Performance</span>
          </p>
          <span>
          ...
          <div className="newProductSet">
            ...
            <div className="setInfo">
              ...
              <p>
                ...
                capacity, ensuring safety and stability. Visualize strength with
                robust steel frameworks.
              </p>
            </div>
          </div>
          <div className="newProductSet">
